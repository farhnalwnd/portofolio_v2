...
<template>
  <router-link
    ...
    class="featured-card group relative block overflow-hidden rounded-2xl bg-white/80 dark:bg-white/8 backdrop-blur-2xl border border-black/5 dark:border-white/12 shadow-xl dark:shadow-2xl dark:shadow-accent-custom/5 transition-all duration-300 ease-out hover:scale-[1.02] hover:border-accent-custom/30 dark:hover:border-accent-custom/50 hover:shadow-accent-custom/10 dark:hover:shadow-accent-custom/20 w-full aspect-[4/3] sm:aspect-video md:aspect-auto md:h-[55vh]"
  >
